...
function AboutPage() {
  return (
    <div style={{ padding: "30px 20px", textAlign: "center", lineHeight: "1.8", fontSize: "18px" }}>
      ...
      <p>
		<strong>Volám sa Peter</strong>, pochádzam zo Slovenska, konkrétne z mesta Bratislava, a narodil som sa v roku
		...
		serverov, <strong>ELK stack (Elasticsearch, Logstash, Kibana)</strong> na analýzu a vizualizáciu logov, 
		<strong>AdGuard</strong>, <strong>Cacti</strong>, <strong>WhatsUp Gold</strong>, <strong>Monit</strong>, 
		<strong>Windows Server</strong>, <strong>routery Zyxel</strong>, <strong>IceWarp mailový server</strong> a ďalšie.
	</p>
	<p>
		Tieto technológie som nielen implementoval, ale aj optimalizoval podľa potrieb firmy, čím som zabezpečoval stabilný chod IT
	...
	<p>
		Programovaniu som sa začal venovať v rámci svojich záujmov. Medzi moje najnovšie projekty patrí{" "}
		<strong>Vocabular</strong>, desktopová aplikácia pre precvičovanie anglicko-slovenských slovíčok. Táto aplikácia vznikla
		výsledkom mojej túžby spojiť technológiu s praktickým nástrojom na učenie. Program som vytvoril nielen pre seba, ale aj
		pre všetkých, ktorí chcú zlepšiť svoje jazykové znalosti.
	</p>
